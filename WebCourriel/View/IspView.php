...
<form action="$url_submit" name="isp_form" method="post" id="isp_form">
	...
	<fieldset>
		...
		<p>
			...
			<input name="imap_hostname" id="input_imap_hostname" type="text" required />
		</p>
		<p>
			<label for="input_imap_port">$label_imap_port</label>
			<input name="imap_port" id="input_imap_port" type="number" required />
		</p>
	...
	<fieldset>
		...
		<p>
			...
			<input name="smtp_hostname" id="input_smtp_hostname" type="text" required />
		</p>
		<p>
			<label for="input_smtp_port">$label_smtp_port</label>
			<input name="smtp_port" id="input_smtp_port" type="number" required />
		</p>
